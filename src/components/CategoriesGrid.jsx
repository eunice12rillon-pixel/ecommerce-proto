...
const categories = [
  {
    ...
    description: "Watercolor, acrylic, oil paints & brushes",
  ...
  },
  {
    ...
    description: "Canvas, sketchpads, drawing papers",
  ...
  },
  {
    ...
    description: "Beads, strings, jewelry tools",
    icon: <FaGem size={30} />,
  ...
  },
  {
    ...
    description: "Wood blocks, chisels, carving tools",
    icon: <FaCube size={30} />,
  ...
  },
  {
    ...
    description: "Recycled & sustainable art materials",
    icon: <FaLeaf size={30} />,
  ...
  {
    title: "Craft Kits",
    description: "DIY kits for origami, paper crafts",
  ...
  },
  {
    ...
    description: "Baskets, mats, traditional weaving",
  ...
  },
  {
    ...
    description: "Bamboo & rattan chairs, lamps, trays",
